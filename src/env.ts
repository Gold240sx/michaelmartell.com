...
export const env = createEnv({
	...
	client: {
		...
		NEXT_PUBLIC_PRICE_ID_BASIC_YEARLY: z.string().min(1),
		NEXT_PUBLIC_PRICE_ID_PREMIUM_YEARLY: z.string().min(1),
	...
	runtimeEnv: {
		...
		NEXT_PUBLIC_PRICE_ID_BASIC_YEARLY:
			process.env.NEXT_PUBLIC_PRICE_ID_BASIC_YEARLY,
		NEXT_PUBLIC_PRICE_ID_PREMIUM_YEARLY:
			process.env.NEXT_PUBLIC_PRICE_ID_PREMIUM_YEARLY,
